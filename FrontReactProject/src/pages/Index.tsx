        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
              Advanced AI analysis for text and image similarity detection. 
              Protect your academic integrity with cutting-edge technology.
            </p>
          </div>
            ...
            <div className="p-6">
              ...
              {activeTab === "scores" && (
                <SimilarityScore
                  ...
                  riskLevel={results.key_findings?.risk_level}
                  totalSentences={results.total_sentences}
                  totalImages={results.total_images_checked}
                  documentsCompared={results.key_findings?.documents_compared}
                />
              )}
